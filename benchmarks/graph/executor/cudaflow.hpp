...
std::pair<double, double> GraphExecutor::run(size_t N, std::string job) {
...
std::pair<double, double> GraphExecutor::run_matmul(size_t N) {
...
std::pair<double, double> GraphExecutor::run_cudaflow_reduce(size_t N) {
...
std::pair<double, double> GraphExecutor::run_cudaflow_reduce2(size_t N) {
...
std::pair<double, double> GraphExecutor::run_sleep() {
  auto constr_tic = std::chrono::steady_clock::now();
