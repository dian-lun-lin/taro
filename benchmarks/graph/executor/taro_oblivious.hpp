...
class TaroObliviousGraphExecutor: public GraphExecutor {

  public:
    TaroObliviousGraphExecutor(Graph& graph, int dev_id, size_t num_threads, size_t num_streams = 0);
  ...
  private:
    ...
    taro::TaroOblivious _taro;
};

TaroObliviousGraphExecutor::TaroObliviousGraphExecutor(Graph& graph, int dev_id, size_t num_threads, size_t num_streams):
  GraphExecutor{graph, dev_id, num_threads, num_streams}, _taro{num_threads, num_streams} {
}

std::pair<double, double> TaroObliviousGraphExecutor::run_loop(int cpu_time, int gpu_time) {
...
std::pair<double, double> TaroObliviousGraphExecutor::run_data(int data_size) {
  auto constr_tic = std::chrono::steady_clock::now();
