...
TEST_CASE("linear_chain_v1.2threads" * doctest::timeout(300)) {
  linear_chain_v1(99, 2);
}

TEST_CASE("linear_chain_v1.3threads" * doctest::timeout(300)) {
  linear_chain_v1(712, 3);
}

TEST_CASE("linear_chain_v1.4threads" * doctest::timeout(300)) {
  linear_chain_v1(443, 4);
}

TEST_CASE("linear_chain_v1.5threads" * doctest::timeout(300)) {
  linear_chain_v1(1111, 5);
}

TEST_CASE("linear_chain_v1.6threads" * doctest::timeout(300)) {
  linear_chain_v1(2, 6);
}

TEST_CASE("linear_chain_v1.7threads" * doctest::timeout(300)) {
  linear_chain_v1(5, 7);
}

TEST_CASE("linear_chain_v1.8threads" * doctest::timeout(300)) {
